...
class CheckersGame:
    ...
    def create_menu(self):
        ...
        title = tk.Label(
            self.menu_frame, text="Warcaby 🟤⚪", font=("Arial", 32, "bold"), bg="#EEE"
        )
        title.pack(pady=50)

        btn_pvp = tk.Button(
            self.menu_frame,
            text="🧍‍♂️ vs 🧍‍♀️  (2 graczy)",
            font=("Arial", 20),
            width=30,
    ...
    def start_game(self, mode):
        ...
        self.canvas = tk.Canvas(
            self.root, width=BOARD_SIZE * TILE_SIZE, height=BOARD_SIZE * TILE_SIZE
        )
        self.canvas.pack()
